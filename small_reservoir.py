...
for wl_idx, w in tqdm(enumerate(wavelengths), desc="Processing wavelengths", total=len(wavelengths)):
    ...
    MultiModeInterferometer = ideal.make_mmi_model(r = 4, s = 4)
    models = {
    ...
    for k in range(0,7):
        group_delay = []
        group_delay_ts = []
        for i in range(0, num_delay*(k+1)):
            netlist = {}
            netlist["instances"] = {}
            netlist["connections"] = {}
            netlist["ports"] = {}
            
            netlist["instances"]["wg2"] = "waveguide"
            netlist["ports"]["o0"] = "wg2,o0"
            netlist["ports"]["o1"] = "wg2,o1"
    ...
    # combined_netlist["connections"]["final_sim_split,o2"] = "mmi_simmer,o1"
    ...
    # combined_netlist["ports"]["o2"] = "final_sim_split,o2"
    # combined_netlist["ports"]["o3"] = "final_sim1,o1"
    # combined_netlist["ports"]["o4"] = "final_sim2,o1"
    # combined_netlist["ports"]["o5"] = "final_sim3,o1"
    # combined_netlist["ports"]["o6"] = "final_sim4,o1"
    # combined_netlist["ports"]["o7"] = "final_sim5,o1"
    # combined_netlist["ports"]["o8"] = "final_sim6,o1"
    # combined_netlist["ports"]["o9"] = "final_sim7,o1"
    # combined_netlist["ports"]["o10"] = "final_sim8,o1"


    for i in range(8,16):
        combined_netlist["ports"][f"o{i-5}"] = f"mmi_simmer,o{i}"
    combined_netlist["ports"]["o2"] = "mmi_simmer,o0"
    combined_netlist["ports"]["o16"] = "final_sim_split,o9"
    # combined_netlist["connections"]["final_sim3,o1"] = "mmi_simmer,o8"
...
np.savez_compressed(
    "X_mmi_binary_5__few_delay_lines.npz",
